    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='img', upload_to='actors/', verbose_name='Изображение')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=False, verbose_name='Дата выхода')),
                ('country', models.CharField(max_length=30, verbose_name='Страна')),
                ('world_premiere', models.CharField(default=datetime.date.today, max_length=15, verbose_name='Премьера в мире')),
                ...
                ('price', models.DecimalField(decimal_places=3, default=False, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Описание')),
                ('image', models.ImageField(default='img', upload_to='movie_shots/', verbose_name='Изображение')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.movie', verbose_name='Фильм')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='нравится', to='movies.movie')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='нравится', to='user_profile.customerprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Favorite',
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Избранное', to='movies.movie')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Избранное', to='user_profile.customerprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Basket',
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Корзина', to='movies.movie')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Корзина', to='user_profile.customerprofile')),
            ],
        ),
    ]
